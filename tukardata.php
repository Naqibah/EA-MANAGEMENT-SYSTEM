...
<body>
	<div class="nav">
		...
		<a href="emonitor(JPN).php"><b>Laman Utama</b></a>
	</div>
	...
	<div id="contact">
		<div class="info">
			<h1>E - MONITORING<br>(Seremban)</h1><br>
				...
				$sql = "SELECT namaSekolah, tarikh, masa FROM keputusan WHERE daerah='Seremban' AND subjek='Bahasa Malaysia'";
			...
			$sql1 = "UPDATE pentaksir SET tarikh='$tarikh',masa='$masa' WHERE namaSekolah='$sekolah' AND subjek='Bahasa Malaysia'";
			$sql2 = "DELETE FROM keputusan WHERE namaSekolah='$sekolah' AND subjek='Bahasa Malaysia'";

			if(mysqli_query($conn, $sql1)){
			echo "<b>Data berjaya ditukar</b>";
			} else{
